...
- Brew photograph used in `web/assets/brew-server.webp`: generated with OpenAI image generation from the user-provided coffee-server reference image in this conversation. The generated image was then losslessly sourced from the conversation output and encoded to WebP for web delivery.
